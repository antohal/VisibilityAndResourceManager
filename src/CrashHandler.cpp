...
{   
	...
	wsprintfW(sFileName, L"VisManCrashDumps//%i-%02i-%02i %02i.%02i.%02i Crash.dmp",
		CrashTime.wYear,CrashTime.wMonth,CrashTime.wDay,
		CrashTime.wHour,CrashTime.wMinute,CrashTime.wSecond);


	if (CreateDirectoryW(L"CrashDumps", NULL) || ERROR_ALREADY_EXISTS == GetLastError())
	{
...
struct CrashHandlerInstaller
{
	...
	{
		static CCrashHandler _crashHandler;
		_crashHandler.SetProcessExceptionHandlers();
		_crashHandler.SetThreadExceptionHandlers();
	}
};
