...
public:
	...
	// [настроечный параметр, по умолчанию = 10]
	// (например при угловой скорости вращения 10 град/с, баунд бокс поворачивается на 100 град)
	void SetRotationRatePotentialVisibilityMultiplier(float rateMultiplier);

	// Установить интервал усреднения угловой скорости [по умолчанию 0.25 с]
